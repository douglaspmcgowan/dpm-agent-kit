...
Four self-contained, interactive explanations of the kit. **Open `index.html` in a browser** to
pick one — or open any file directly. No server, no build, no external dependencies (they use
JetBrains Mono if you have it installed, falling back to your system monospace).

| File | Style | Best for |
|---|---|---|
| `index.html` | Launcher | Pick one of the four. |
